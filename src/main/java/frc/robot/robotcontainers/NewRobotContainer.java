...
//     driver.a().whileTrue(new RotateAngleToVision(s_Swerve, driver, Math.PI));
    ...
    driver.a().whileTrue(PhotonSubsystem.getInstance().getAprilTagCommand(PhotonPositions.FAR_SPEAKER_RED, driver)).onFalse(Commands.runOnce(()->{},SwerveSubsystem.getInstance()));
